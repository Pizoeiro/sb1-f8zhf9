  ...
  return (
    <div className="max-w-md mx-auto space-y-6">
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold mb-2">Equilíbrio da Natureza</h2>
        <p className="text-sm opacity-75 mb-6">
          Mantenha o equilíbrio ecológico coletando elementos positivos
          e evitando ameaças ao meio ambiente.
        </p>
      </div>
